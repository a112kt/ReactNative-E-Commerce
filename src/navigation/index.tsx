...
// drawer nav type for inside-drawer navigation (kept if needed elsewhere)
...
function MyDrawer() {
  ...
  // note: we don't need drawerNav here for the favorite action anymore
  ...
  // Favorite navigation: navigate via root stack -> MyTabs -> MyDrawer -> Whishlist
  const Favorite = () => {
    ...
    } as any); // 'as any' to satisfy nested params typing for this call
  };
